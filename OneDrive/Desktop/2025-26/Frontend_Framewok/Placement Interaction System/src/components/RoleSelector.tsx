...
const roles = [
  ...
  },
  {
    ...
    title: 'Student',
    description: 'Explore job opportunities, apply for positions, and track applications',
    icon: GraduationCap,
    color: 'bg-blue-500',
  },
  {
  ...
  {
    id: 'placement-officer' as UserRole,
    title: 'Placement Officer',
    description: 'Track placement records, generate reports, and facilitate interactions',
    icon: UserCheck,
    color: 'bg-purple-500',
  },
];
