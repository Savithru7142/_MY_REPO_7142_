...
import { mockStudentProfiles, StudentProfile } from '../data/mockData';

export function CandidatesManagement() {
  const [searchQuery, setSearchQuery] = useState('');
  const [filterStatus, setFilterStatus] = useState<'all' | 'placed' | 'seeking' | 'not-interested'>('all');
  ...
  const filteredCandidates = mockStudentProfiles.filter(candidate => {
    ...
    const matchesFilter = filterStatus === 'all' || candidate.placementStatus === filterStatus;
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Browse and manage student candidate profiles</p>
      </div>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-start justify-between">
                  ...
                  <Badge className={getStatusColor(selectedCandidate.placementStatus)}>
